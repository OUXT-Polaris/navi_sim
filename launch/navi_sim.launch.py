...
def getLidarSimComponent(lidar_name):
    config_directory = os.path.join(get_package_share_directory("navi_sim"), "config")
    ...
    object_config_path = os.path.join(
        get_package_share_directory("navi_sim"), "config", "objects.json"
    )
...
def getNaviSimComponent():
    component = ComposableNode(
        package="navi_sim", plugin="navi_sim::NaviSimComponent", name="navi_sim_node"
    )
    return component
...
def generate_launch_description():
    rviz_config_dir = os.path.join(
        get_package_share_directory("navi_sim"), "config", "navi_sim.rviz"
    )
